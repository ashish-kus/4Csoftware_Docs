...
sys.get_msgline1() returns the value of the 4C environment variable
XLMSGLINE1.
...
sys.get_msgline1() can be called from anywhere. It is most likely used
in system programs that may allow the user to change the value.

Example:

In the system program sys.help.set, the Init PCL calls
sys.get_msgline1() in order to display the current value before allowing
...
See Also: sys.get_fkhelp() sys.get_help() sys.get_msgline2()
