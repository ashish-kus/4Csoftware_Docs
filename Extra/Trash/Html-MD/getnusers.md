...
sys.get_nusers() can be called from anywhere. It is used by some of the
...
Each copy of 4C and each 4C utility counts as one process.
sys.get_nusers() always returns \<= sys.get_maxusers().

Bugs/Features/Comments:

See Also: sys.get_idx() sys.get_maxusers() sys.get_ttyname()
sys.get_username()
