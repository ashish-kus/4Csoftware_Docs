...
sys.get_maxusers() returns the max number of users that 4C is configured
for.
...
sys.get_maxusers() can be called from anywhere. It is used by some of
the system configuration/display programs.
...
sys.get_maxusers() returns the max number of users that 4C is configured
for. This corresponds to the Users parameter in the XLCONFIG file.

Bugs/Features/Comments:

See Also: sys.get_idx() sys.get_nusers() sys.get_ttyname()
sys.get_username()
